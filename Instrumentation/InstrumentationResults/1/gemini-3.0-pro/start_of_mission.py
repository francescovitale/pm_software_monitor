...
class ERTMSOnBoardSystem:
    ...
    def _procedure_s2_level_entry(self):
        ...
        if self.level_status == DataStatus.UNKNOWN:
            # Although explicit level entry isn't a named task, it often follows invalid checks.
            # Assuming flow loops back through validation.
    ...
    def _procedure_a31_d31_a32_rbc_session(self):
        ...
        if response == "session_open":
            ...
            self.communication_session_active = False
            self._log("som_retryconn_dmi_1") # Assuming retry loop or fail
            return 'A32'
    ...
    def _procedure_s21_s25_l2_grant(self):
        ...
        # Simulating RBC internal checks logged here for completeness of trace
